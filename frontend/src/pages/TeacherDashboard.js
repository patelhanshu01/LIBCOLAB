...
const TeacherDashboard = () => {
  ...
  const [quizForm, setQuizForm] = useState({ title: '', module_id: '', total_marks: 10, passing_marks: 5, questions: [] });
  ...
  const openAddQuiz = (course) => {
    ...
    setQuizForm({ title: '', module_id: '', total_marks: 10, passing_marks: 5, questions: [] });
      ...
      <div className="space-y-6" data-testid="teacher-dashboard">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Manage courses, modules, quizzes and track students</p>
          </div>
        ...
        <Tabs defaultValue="courses">
          <TabsList>
            <TabsTrigger value="courses" data-testid="teacher-tab-courses">My Courses ({courses.length})</TabsTrigger>
                  ...
                  {isExpanded && (
                    <div className="border-t bg-muted/20 p-6 space-y-6">
                      ...
                      {courseEnrollments.length > 0 && (
                        <div>
                          <h4 className="font-semibold mb-3 flex items-center gap-2"><Users className="w-4 h-4" /> Enrolled Students ({courseEnrollments.length})</h4>
